...
def run_GUI(computer=False):
    ...
    HogGUI.IMAGES = {
        1: PhotoImage(file='cs61a/hog/images/die1.gif'),
        2: PhotoImage(file='cs61a/hog/images/die2.gif'),
        3: PhotoImage(file='cs61a/hog/images/die3.gif'),
        4: PhotoImage(file='cs61a/hog/images/die4.gif'),
        5: PhotoImage(file='cs61a/hog/images/die5.gif'),
        6: PhotoImage(file='cs61a/hog/images/die6.gif'),
    }
...
def run(*args):
    ...
    run_GUI(computer=True)  # run_GUI(computer=args.final)      (python hog_gui.py -f)
